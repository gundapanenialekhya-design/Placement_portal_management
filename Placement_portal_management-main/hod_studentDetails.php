    ...
    <table border='3' cellspacing="0" align="center" style="background: color #757575;">
        ...
        <tbody>
            ...
            <tr>
                ...
                <?php 
                echo "<td>" . "<a href='uploaded_files/Develet.pdf' width='100px' height='100px' style='text-decoration:none;color:black;' target='_blank'><img src='getfile.jpg' alt='getfile' width='20' height='20'></a>" . "</td>";
